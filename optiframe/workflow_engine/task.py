...
class Task(abc.ABC, Generic[T]):
    ...
    The task can also depend on base_data by other tasks by specifying dependencies in the constructor.
    The type annotation of the constructor parameters determine which dependency will be injected.
    If the base_data is generated by a task in the same step, the task will be executed before this one.
    """
